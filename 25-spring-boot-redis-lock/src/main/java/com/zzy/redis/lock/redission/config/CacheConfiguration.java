...
public class CacheConfiguration {
    ...
    @ConditionalOnExpression("'${custom.redis.mode}'=='single' or '${custom.redis.mode}'=='cluster' or '${custom.redis.mode}'=='sentinel'")
    protected class RedissonSingleClientConfiguration {
        ...
        @Bean("CustomRedissonClient")
        @ConditionalOnProperty(name = "custom.redis.mode", havingValue = "single")
         ...
         */
        @Bean("CustomRedissonClient")
        @ConditionalOnProperty(name = "custom.redis.mode", havingValue = "cluster")
        ...
        @Bean("CustomRedissonClient")
        @ConditionalOnProperty(name = "custom.redis.mode", havingValue = "sentinel")
